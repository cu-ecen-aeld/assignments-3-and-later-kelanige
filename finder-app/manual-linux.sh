...
TOOLCHAIN_DIR=/home/ki/toolchains/gcc-arm-10.2-2020.11-x86_64-aarch64-none-linux-gnu
...
if [ ! -d "${OUTDIR}/assignments-3-and-later-kelanige" ]
then
    git clone git@github.com:cu-ecen-aeld/assignments-3-and-later-kelanige.git
    pushd assignments-3-and-later-kelanige/finder-app
else
    pushd assignments-3-and-later-kelanige/finder-app
fi
